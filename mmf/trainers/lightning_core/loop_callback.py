...
class LightningLoopCallback(Callback):
    ...
    def on_validation_start(self, trainer: Trainer, pl_module: LightningModule):
        ...
        self.snapshot_iterations = len(self.lightning_trainer.data_module.val_loader)
    ...
    def on_validation_batch_end(
        ...
        Meter.update_meter_from_report(
            self.val_combined_report, pl_module.val_meter, should_upate_loss=False
        )
    ...
    def _update_and_create_report(
        ...
        if update_meter:
            Meter.update_meter_from_report(report, update_meter)
    ...
    def _train_log(self, trainer: Trainer, pl_module: LightningModule):
        ...
        Meter.update_meter_from_report(
            self.train_combined_report, pl_module.train_meter
        )
